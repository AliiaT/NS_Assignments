...
if ($y == $z) {
   echo '<p style="text-align:center;color:white;font-size:30px;font-family:fantasy;align=center;"> You have succesfully registered in Eventure-App, please login to the app.</p>';
} else {
